...
DROP TABLE IF EXISTS CDW_SAPP_F_CREDIT_CARD_PARTITIONED_BY_TRANSACTION_TYPE;

SET hive.exec.dynamic.partition=true;
SET hive.exec.dynamic.partition.mode=nonstrict;

CREATE TABLE IF NOT EXISTS CDW_SAPP_F_CREDIT_CARD_PARTITIONED_BY_TRANSACTION_TYPE (
    TRANSACTION_ID INT,
    CUST_SSN INT,
    TIMEID STRING,
    CUST_CC_NO STRING,
...
INSERT OVERWRITE TABLE CDW_SAPP_F_CREDIT_CARD_PARTITIONED_BY_TRANSACTION_TYPE 
